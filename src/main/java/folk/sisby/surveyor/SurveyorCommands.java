							...
							.then(CommandManager.argument("pos", BlockPosArgumentType.blockPos())
								.then(CommandManager.argument("color", StringArgumentType.word())
									...
									.then(CommandManager.argument("name", StringArgumentType.greedyString())
										.executes(c -> execute(c, (s, w, p, sw, e, f) -> SurveyorCommands.addLandmark(w, p, sw, f, c.getArgument("type", Identifier.class), c.getArgument("pos", DefaultPosArgument.class).toAbsoluteBlockPos(c.getSource()), DyeColor.byId(c.getArgument("color", String.class), DyeColor.WHITE), c.getArgument("name", String.class), false)))
									)
								)
							)
						)
						...
						.then(CommandManager.argument("type", IdentifierArgumentType.identifier())
							...
							.then(CommandManager.argument("pos", BlockPosArgumentType.blockPos())
								.then(CommandManager.argument("color", StringArgumentType.word())
									.suggests((c, b) -> CommandSource.suggestMatching(Arrays.stream(DyeColor.values()).map(DyeColor::getId), b))
									.then(CommandManager.argument("name", StringArgumentType.greedyString())
										.executes(c -> execute(c, (s, w, p, sw, e, f) -> SurveyorCommands.addLandmark(w, p, sw, f, c.getArgument("type", Identifier.class), c.getArgument("pos", DefaultPosArgument.class).toAbsoluteBlockPos(c.getSource()), DyeColor.byId(c.getArgument("color", String.class), DyeColor.WHITE), c.getArgument("name", String.class), true)))
									)
								)
							)
						)
