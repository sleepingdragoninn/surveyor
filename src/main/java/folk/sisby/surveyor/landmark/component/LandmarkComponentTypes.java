...
public class LandmarkComponentTypes {
	...
	public static final LandmarkComponentType<Integer> COLOR = register("color", Codec.INT, i -> Text.literal("#").setStyle(Style.EMPTY.withColor(0x00FFFFFF & i)).append(Text.literal(Integer.toHexString(0x00FFFFFF & i).toUpperCase()).formatted(Formatting.GOLD)));
